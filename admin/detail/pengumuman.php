<?php
    ...
    open_page('Detail Pengumuman - Admin');
...
<div class="container mt-3">
  <div class="jumbotron bg-light" style="background:url('<?= BASEURL;?>/public/img/iot2.png') no-repeat center;size:cover;">
    ...
    <img src="../img/<?= $data['gambarPengumuman']; ?>" class="align-self-center mr-5 mt-3" alt="pengumuman1" style="width:450px;length:450px;margin-left:300px;">
